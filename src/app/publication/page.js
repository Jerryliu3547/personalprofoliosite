        ...
        <div className="space-y-6 sm:space-y-10">
          {publications.map((pub, index) => (
            ...
            >
              ...
              {/* Title & Venue */}
              <div className="flex flex-col gap-2 sm:gap-3 pb-5 sm:pb-6 border-b border-white/10">
                <div className="flex items-center gap-2 text-xs font-semibold text-purple-400 flex-wrap">
                ...
                <h2 className="text-xl sm:text-3xl font-bold text-white group-hover:text-purple-300 transition-colors leading-snug sm:leading-tight">
                  {pub.title}
                </h2>

                {/* Authors */}
                <div className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-neutral-300 flex-wrap mt-1">
                  <PersonIcon fontSize="small" className="text-purple-400 shrink-0" />
                  <span>Authors:</span>
              ...
              <div className="mt-4 sm:mt-6 space-y-2.5 sm:space-y-3">
                ...
                {pub.highlights.map((h, hIdx) => (
                  <div key={hIdx} className="flex items-start gap-2.5 pl-1 sm:pl-2">
              ...
              {/* Abstract */}
              <div className="mt-4 sm:mt-6 p-3.5 sm:p-4 rounded-xl bg-white/5 border border-white/10">
                <h3 className="text-[10px] sm:text-xs font-semibold text-neutral-400 uppercase tracking-wider mb-1.5">
                  Abstract
                </h3>
              ...
              {/* Tags */}
              <div className="mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-white/5 flex flex-wrap items-center gap-2">
              ...
              {/* Actions & Links */}
              <div className="mt-5 sm:mt-6 pt-5 sm:pt-6 border-t border-white/10 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
                <div className="flex items-center gap-2.5 sm:gap-3 flex-wrap">
                  <Link
                    href={pub.arxivLink}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center gap-2 px-4 py-2 sm:px-5 sm:py-2.5 rounded-full bg-purple-600 hover:bg-purple-500 text-white font-semibold text-xs transition-all shadow-[0_0_15px_rgba(168,85,247,0.3)] hover:shadow-[0_0_20px_rgba(168,85,247,0.5)] flex-1 sm:flex-none"
                  >
                  ...
                  <Link
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center gap-2 px-4 py-2 sm:px-5 sm:py-2.5 rounded-full bg-neutral-900 border border-white/20 hover:border-purple-400 text-white font-semibold text-xs transition-all flex-1 sm:flex-none"
                  >
