    ...
    <div className="min-h-screen w-full bg-black-100 bg-grid-white/[0.03] relative flex flex-col items-center justify-start overflow-hidden text-white">
      ...
      <div className="relative z-10 w-full pt-24 sm:pt-40 pb-16 sm:pb-20 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-stretch justify-items-center max-w-5xl mx-auto">
          {/* Georgia Tech Card */}
          <div className="group relative border border-white/10 dark:border-white/20 bg-black/60 backdrop-blur-xl rounded-3xl p-5 sm:p-8 flex flex-col items-start w-full transition-all duration-300 hover:border-purple-500/50 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)]">
            ...
            <div className="h-48 sm:h-72 w-full relative mb-6 rounded-2xl overflow-hidden">
              <EvervaultCardGA text={<Image src={GATECH} alt="Georgia Tech Logo" className="w-20 h-20 sm:w-24 sm:h-24 object-contain" />} />
            </div>
            ...
            <div className="w-full flex flex-col justify-between flex-1">
              <div>
                ...
                <h3 className="text-xs sm:text-base font-semibold text-purple-400 mt-1">
              ...
              <div className="mt-6 pt-4 border-t border-white/10 w-full">
                <p className="text-[10px] sm:text-xs font-semibold text-neutral-400 mb-3 uppercase tracking-wider">
          ...
          <div className="group relative border border-white/10 dark:border-white/20 bg-black/60 backdrop-blur-xl rounded-3xl p-5 sm:p-8 flex flex-col items-start w-full transition-all duration-300 hover:border-purple-500/50 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)]">
            ...
            {/* Interactive Evervault Header */}
            <div className="h-48 sm:h-72 w-full relative mb-6 rounded-2xl overflow-hidden">
              <EvervaultCard text={<Image src={OSULOGO} alt="OSU Logo" className="w-20 h-20 sm:w-24 sm:h-24 object-contain" />} />
            </div>
